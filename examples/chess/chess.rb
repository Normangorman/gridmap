...
class GameWindow < Gosu::Window
	def initialize
		...
		images = {
			straight: 	image_path + 'straight_border.bmp',
			corner: 	image_path + 'corner_border.bmp',

			black:      image_path + 'black_square.bmp',
			white:      image_path + 'white_square.bmp',
		}

		@grid = Gridmap.new("assets/chessboard.txt", symbol_details, 30)
